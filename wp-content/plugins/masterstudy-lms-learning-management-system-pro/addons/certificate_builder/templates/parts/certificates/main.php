<div class="certificates">
    <div class="certificate" v-for="(certificate, key) in certificates">
        ...
        <i class="fa fa-times-circle" @click="deleteCertificate(key)"
           title="<?php esc_attr_e('Delete certificate', 'masterstudy-lms-learning-management-system-pro'); ?>"></i>
        <label class="certificate-label">
            <div class="certificate-image-wrap">
                <img v-if="typeof certificate.thumbnail !== 'undefined' && certificate.thumbnail"
                     v-bind:src="certificate.thumbnail"/>
            </div>
