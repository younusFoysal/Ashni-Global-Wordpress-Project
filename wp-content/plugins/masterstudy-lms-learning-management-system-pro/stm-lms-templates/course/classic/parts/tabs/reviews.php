    ...
    <div class="clearfix stm_lms_average__rating">
        ...
        <div class="average_rating">
            <div class="average_rating_unit heading_font">
                <div class="average_rating_value"><?php echo number_format($average, 1, '.', ''); ?></div>
                ...
                <div class="average_rating_num"><?php printf(esc_html__('%s Ratings', 'masterstudy-lms-learning-management-system-pro'), count($reviews)); ?></div>
            </div>
        </div>
