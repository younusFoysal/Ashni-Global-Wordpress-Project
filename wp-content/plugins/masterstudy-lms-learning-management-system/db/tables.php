...
require_once STM_LMS_PATH . '/db/helpers/user_searches.php';

if(is_admin()) {
    require_once STM_LMS_PATH . '/db/tables_updater.php';
    ...
    require_once STM_LMS_PATH . '/db/tables/user_searches.table.php';
    require_once STM_LMS_PATH . '/db/tables/curriculum_log.table.php';
    require_once STM_LMS_PATH . '/db/tables/curriculum_bind.table.php';
}