<div class="stm_lms_splash_wizard__content_tab"
    ...
    <div class="stm_lms_splash_wizard__field stm_lms_splash_wizard__field_pages">
        ...
        <div class="stm_lms_splash_wizard__field_input">
            ...
            <?php STM_LMS_Templates::show_lms_template('wizard/fields/pages', array(
                'pages' => array(
    ...
    <div class="stm_lms_splash_wizard__field stm_lms_splash_wizard__field_number" v-if="isMarketPlace() && isPro()">
        ...
        <div class="stm_lms_splash_wizard__field_input">
            ...
            <?php STM_LMS_Templates::show_lms_template('wizard/fields/number', array(
