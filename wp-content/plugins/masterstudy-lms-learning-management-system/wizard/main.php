...
add_action('stm_masterstudy_importer_done_data', function ($data) {
...
class STM_LMS_Wizard_Interface
{
    ...
    static $redirect = 'stm_lms_wizard_redirect';
    ...
    public function __construct()
    {
        ...
        add_action('wp_ajax_stm_lms_wizard_save_settings', [$this, 'save']);
        add_action('wp_ajax_stm_lms_wizard_save_business_type', [$this, 'save_business_type']);

        add_action('admin_init', [$this, 'redirect']);

        add_action('stm_masterstudy_importer_done', 'redirect_to_wizard', 100);
    }
    ...
    {
        if ($hook === 'tools_page_stm-lms-wizard') {

            wp_register_script('vue-range-slider', STM_LMS_URL . '/assets/vendors/vue-range-slider.min.js');
            wp_register_style('vue-range-slider', STM_LMS_URL . '/assets/vendors/vue-range-slider.css');
            ...
            wp_localize_script('stm-lms-wizard/wizard', 'stm_lms_splash_wizard', array(
                ...
                'steps' => array(
                    ...
                    'single_course' => esc_html__('Single Course', 'masterstudy-lms-learning-management-system'),
    ...
    {
        wp_redirect(admin_url('admin.php?page=stm-lms-wizard'));
    }
