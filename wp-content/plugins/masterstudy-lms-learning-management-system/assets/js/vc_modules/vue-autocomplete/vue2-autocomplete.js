...
(function webpackUniversalModuleDefinition(root, factory) {
  if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object') exports["Vue2Autocomplete"] = factory();else root["Vue2Autocomplete"] = factory();
})(void 0, function () {
  return (
    /******/
    function (modules) {
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var Component = normalizeComponent(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_vue_autocomplete_vue__["a"
      /* default */
      ], __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e47ae2be_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_vue_autocomplete_vue__["a"
      /* default */
      ], __vue_styles__, __vue_scopeId__, __vue_module_identifier__);
      ...
      __webpack_exports__["a"] = {
        ...
        methods: {
          ...
          handleInput: function handleInput(e) {
            ...
            this.showList = true; // Callback Event

            if (this.onInput) this.onInput(value); // If Debounce
          ...
          handleKeyDown: function handleKeyDown(e) {
            var key = e.keyCode; // Disable when list isn't showing up

            if (!this.showList) return; // Key List

            var DOWN = 40;
            var UP = 38;
            var ENTER = 13;
            var ESC = 27; // Prevent Default for Prevent Cursor Move & Form Submit
          ...
          handleDoubleClick: function handleDoubleClick() {
            this.json = [];
            this.getData(""); // Callback Event

            this.onShow ? this.onShow() : null;
            this.showList = true;
          },
          handleBlur: function handleBlur(e) {
            var _this2 = this; // Callback Event
          ...
          handleFocus: function handleFocus(e) {
            this.focusList = 0; // Callback Event
          ...
          selectList: function selectList(data) {
            ...
            var clean = this.cleanUp(data); // Put the selected data to type (model)

            this.type = clean[this.anchor]; // Hide List

            this.showList = false; // Callback Event
          ...
          doAjax: function doAjax(val) {
            var _this5 = this; // Callback Event


            this.onBeforeAjax ? this.onBeforeAjax(val) : null; // Compose Params

            var params = this.composeParams(val); // Init Ajax

            var ajax = new XMLHttpRequest();
            ajax.open('GET', this.url + "?" + params, true);
            this.composeHeader(ajax); // Callback Event
            ...
            ajax.addEventListener('loadend', function (e) {
              ...
              var json = JSON.parse(responseText); // Callback Event
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = __WEBPACK_IMPORTED_MODULE_0__components_vue_autocomplete_vue__["a"
      /* default */
      ];
      /***/
    },
