...
function stm_lms_courses_grid_display($atts)
{
    ...
    <div class="stm_lms_courses_grid stm_lms_courses">
		<?php STM_LMS_Templates::show_lms_template('courses/grid', array('args' => $atts));
		if(!empty($atts['load_more'])) STM_LMS_Templates::show_lms_template('courses/load_more', array('args' => $atts)); ?>
    </div>
