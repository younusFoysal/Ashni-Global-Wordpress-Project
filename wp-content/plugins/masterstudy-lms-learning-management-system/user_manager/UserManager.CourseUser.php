...
class STM_LMS_User_Manager_Course_User
{
    ...
    function reset_student_progress()
    {
    ...
    function set_student_progress() {
        ...
        if (empty($data['user_id']) or empty($data['course_id']) or empty($data['item_id'])) die;
    ...
    static function complete_assignment($user_id, $course_id, $lesson_id, $completed) {
    ...
    static function complete_quiz($user_id, $course_id, $quiz_id, $completed) {
    ...
    /*RESET ITEMS*/
    static function reset_lesson($user_id, $course_id, $lesson_id) {

        stm_lms_delete_user_lesson($user_id, $course_id, $lesson_id);

    }

    static function reset_quiz($user_id, $course_id, $quiz_id) {

        stm_lms_delete_user_quiz($user_id, $course_id, $quiz_id);

    }

    static function reset_assignment($user_id, $course_id, $assignment_id) {
        $args = array(
            'posts_per_page' => -1,
            'post_type' => 'stm-user-assignment',
            'post_status' => array(
